...
--               c:/Users/catar/Nextcloud/windowsToLinux/example2/CustomPeriphDemo/CustomPeriphDemo.srcs/sources_1/bd/mb_design/ip/mb_design_CustomPeriphIPCore_0_0/mb_design_CustomPeriphIPCore_0_0_sim_netlist.vhdl
...
entity mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0_S00_AXI : entity is "CustomPeriphIPCore_v1_0_S00_AXI";
end mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0_S00_AXI;

architecture STRUCTURE of mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0_S00_AXI is
  ...
  signal \PWM_out0_inferred__0/i__carry_n_1\ : STD_LOGIC;
  signal \PWM_out0_inferred__0/i__carry_n_2\ : STD_LOGIC;
  signal \PWM_out0_inferred__0/i__carry_n_3\ : STD_LOGIC;
  signal \PWM_out0_inferred__1/i__carry_n_1\ : STD_LOGIC;
  ...
  signal \s_pwmCounter[0]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[1]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[2]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[3]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[4]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[5]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[6]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[7]_i_1_n_0\ : STD_LOGIC;
  signal \s_pwmCounter[7]_i_2_n_0\ : STD_LOGIC;
  signal s_pwmCounter_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \NLW_s_clkEnbCnt0_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \s_pwmCounter[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_pwmCounter[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_pwmCounter[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_pwmCounter[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_pwmCounter[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_pwmCounter[7]_i_1\ : label is "soft_lutpair3";
begin
...
\PWM_out0_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => PWM_out(1),
      CO(2) => \PWM_out0_inferred__0/i__carry_n_1\,
...
\PWM_out0_inferred__1/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => PWM_out(2),
      CO(2) => \PWM_out0_inferred__1/i__carry_n_1\,
...
s_clkEnbCnt0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => s_clkEnbCnt0_carry_i_1_n_0,
      S(2) => s_clkEnbCnt0_carry_i_2_n_0,
      S(1) => s_clkEnbCnt0_carry_i_3_n_0,
      S(0) => s_clkEnbCnt0_carry_i_4_n_0
    );
\s_clkEnbCnt0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \s_clkEnbCnt0_carry__0_i_1_n_0\,
      S(2) => \s_clkEnbCnt0_carry__0_i_2_n_0\,
      S(1) => \s_clkEnbCnt0_carry__0_i_3_n_0\,
      S(0) => \s_clkEnbCnt0_carry__0_i_4_n_0\
    );
\s_clkEnbCnt0_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\s_clkEnbCnt0_carry__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\s_clkEnbCnt0_carry__0_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\s_clkEnbCnt0_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\s_clkEnbCnt0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_s_clkEnbCnt0_carry__1_CO_UNCONNECTED\(3),
      ...
      S(3) => '0',
      S(2) => \s_clkEnbCnt0_carry__1_i_1_n_0\,
      S(1) => \s_clkEnbCnt0_carry__1_i_2_n_0\,
      S(0) => \s_clkEnbCnt0_carry__1_i_3_n_0\
    );
\s_clkEnbCnt0_carry__1_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\s_clkEnbCnt0_carry__1_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\s_clkEnbCnt0_carry__1_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
s_clkEnbCnt0_carry_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
s_clkEnbCnt0_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
s_clkEnbCnt0_carry_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
s_clkEnbCnt0_carry_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\s_pwmCounter[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE01"
    )
        port map (
...
\s_pwmCounter[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0001"
    )
        port map (
...
\s_pwmCounter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\s_pwmCounter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\s_pwmCounter[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
    )
        port map (
...
\s_pwmCounter[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\s_pwmCounter_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s_pwmEnable,
...
\s_pwmCounter_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s_pwmEnable,
...
\s_pwmCounter_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s_pwmEnable,
...
\s_pwmCounter_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s_pwmEnable,
...
\s_pwmCounter_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s_pwmEnable,
...
s_pwmEnable_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0 : entity is "CustomPeriphIPCore_v1_0";
end mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0;

architecture STRUCTURE of mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0 is
begin
CustomPeriphIPCore_v1_0_S00_AXI_inst: entity work.mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_CustomPeriphIPCore_0_0 is
  port (
    PWM_out : out STD_LOGIC_VECTOR ( 2 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of mb_design_CustomPeriphIPCore_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mb_design_CustomPeriphIPCore_0_0 : entity is "mb_design_CustomPeriphIPCore_0_0,CustomPeriphIPCore_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of mb_design_CustomPeriphIPCore_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of mb_design_CustomPeriphIPCore_0_0 : entity is "CustomPeriphIPCore_v1_0,Vivado 2019.2";
end mb_design_CustomPeriphIPCore_0_0;

architecture STRUCTURE of mb_design_CustomPeriphIPCore_0_0 is
...
U0: entity work.mb_design_CustomPeriphIPCore_0_0_CustomPeriphIPCore_v1_0
     port map (
      PWM_out(2 downto 0) => PWM_out(2 downto 0),
