...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../MultiClkDomainDemo.srcs/sources_1/ip/FIFO16x7/sim/FIFO16x7.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FIFO16x7 xil_defaultlib.glbl -o FIFO16x7_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FIFO16x7_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key FIFO16x7_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc FIFO16x7_simv.daidir)
