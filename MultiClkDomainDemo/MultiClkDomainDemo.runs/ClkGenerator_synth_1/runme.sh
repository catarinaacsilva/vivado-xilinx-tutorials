...
HD_PWD='C:/Users/asroliveira/CloudStation/CR/2018/MultiClkDomainDemo/MultiClkDomainDemo.runs/ClkGenerator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClkGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClkGenerator.tcl
