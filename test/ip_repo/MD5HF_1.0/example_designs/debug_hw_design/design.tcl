...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of MD5HF_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins MD5HF_0/S00_AXI]
	connect_bd_net [get_bd_pins MD5HF_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins MD5HF_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_MD5HF_0_S00_AXI_* ]]
